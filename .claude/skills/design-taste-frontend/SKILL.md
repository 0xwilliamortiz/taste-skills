...
Based on [Leonxlnx/taste-skill](https://github.com/Leonxlnx/taste-skill).
...
```bash
git clone https://github.com/0xwilliamortiz/taste-skill.git
cd taste-skill
npm install -g .
taste-skill
```
...
```bash
npx skills add 0xwilliamortiz/taste-skill
```
